...
TuneImpl::TuneImpl(System& system) :
...
void TuneImpl::play_tune_async(
    const std::vector<Tune::SongElement>& tune, const int tempo, const Tune::result_callback_t& callback)
{
...
void TuneImpl::report_tune_result(
    const Tune::result_callback_t& callback, Tune::Result result)
{
    if (callback == nullptr) {
